...
//Tag returns tag.MDEntryDate (272)e
...
//Tag returns tag.ValueDate (9006)
func (f ValueDateField) Tag() quickfix.Tag { return tag.ValueDate }

//NewValueDate returns a new ValueDateField initialized with val
func NewValueDate(val string) ValueDateField {
	return ValueDateField{quickfix.FIXString(val)}
}
